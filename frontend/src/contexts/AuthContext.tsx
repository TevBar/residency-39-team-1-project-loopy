...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    GoogleSignin.configure({
      webClientId: '39855210543-eqbv7f2ia13apocshc46opgtqec5sqld.apps.googleusercontent.com', // ✅ Web client ID from Firebase Console
  ...
  // ✅ Firestore user doc sync on user change
  useEffect(() => {
    if (!user) return;
